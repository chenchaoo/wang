...
public class MainJob {
    ...
    public static void main(String[] args) {
        String filePath = "D://JobNetSourceCode.txt";
        ...
        System.out.println(ExcelRead.generateWorkbook("D://test.xlsx", "test", buildListMap));
    }
    ...
    private void buildParamMap(String name, List<Object> list) {
        ...
        for (String string : propertyArr) {
            if(paramMap.get(string) != null){
            	...
            	if("sys_jp9apl".equals(string)){
            		list.add("owner"+"="+string);
            		paramMap.put(string, "owner");
            	}else if("MIP_COM".equals(string)){
            		list.add("sourceGroup"+"="+string);
            		paramMap.put(string, "sourceGroup");
            	}else if("+0+0".equals(string)){
            		list.add("tmp"+"="+string);
            		paramMap.put(string, "tmp");
            	}else{
